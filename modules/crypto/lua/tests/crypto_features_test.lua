...
-- The randomBytes call returns exactly the requested length, including zero and the documented cap.
...
-- The rsaEncryptPublic call with oaep produces a modulus-sized ciphertext and rejects a malformed key.
local rsaPublicKey = [[
-----BEGIN PUBLIC KEY-----
