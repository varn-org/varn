...
Hashing, keyed hashing, password storage, authenticated encryption, key derivation, encodings, UUIDs, and cryptographically secure random bytes — backed by OpenSSL.
