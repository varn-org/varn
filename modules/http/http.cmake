...
if(NOT DEFINED CACHE{VARN_HTTP_CLIENT_DRIVER})
    set(VARN_HTTP_CLIENT_DRIVER "POCO" CACHE STRING "http client transport: POCO APPLE ANDROID EMSCRIPTEN_FETCH DUMMY")
endif()
set_property(CACHE VARN_HTTP_CLIENT_DRIVER PROPERTY STRINGS POCO APPLE ANDROID EMSCRIPTEN_FETCH DUMMY)
varn_validate_driver(VARN_HTTP_CLIENT_DRIVER POCO APPLE ANDROID EMSCRIPTEN_FETCH DUMMY)
...
# a browser follows a redirect itself and hands over only where it ended up, so the following every other
# target does above its driver has nothing to do there and no synchronous perform to be written against
if(NOT VARN_HTTP_CLIENT_DRIVER STREQUAL "EMSCRIPTEN_FETCH")
    list(APPEND VARN_SOURCES "${CMAKE_CURRENT_LIST_DIR}/src/HttpRedirects.cpp")
endif()
