...
An in-process HTTP/1.1 server with a higher-level app framework (routing, middleware, sessions, cookies, WebSockets, SSE, security middleware), an HTTP client, and URL percent-encoding helpers.
