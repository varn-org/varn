...
Run shell commands and read the process environment — `exec` runs off the main loop and resolves a promise, while the environment, working-directory, and argument accessors are synchronous.
