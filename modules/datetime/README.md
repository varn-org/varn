...
Parsing, formatting, and calendar arithmetic on instants — a single point in time held with millisecond precision, internally as UTC, so instants always compare and subtract cleanly. Backed by Howard Hinnant's date.h.
