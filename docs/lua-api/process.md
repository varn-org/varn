...
Run commands and read the process environment. `exec` runs off the main loop and returns a promise. The environment and working-directory accessors are synchronous.
